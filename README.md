...
Des video.mp4 devrait etre dans backend_test/videospour tester l'ajout d'une viéo(comunication entre back; front ; et bdd)
...
vous pouvez accéder à Prometheus sur http://localhost:9090. Dans l'onglet graph , executer par exemple
...
le site fonctionnais, mais en faite non
...
Dans le dossier k8s il y a les deployements pour ce projets : 
...
tout charge, le site est up et visionnable
    
    projet/kubernetes$ kubectl get pods -n default                          
    NAME                        READY   STATUS    RESTARTS      AGE
...
Il se remet à fonctionner mais ne veux pas fonctionner; les requètes post et get passe pas
